...
# ============================================================
# DRUG REPURPOSING AI - LOGISTIC REGRESSION
# ============================================================

print("=" * 70)
print("DRUG REPURPOSING AI - LOGISTIC REGRESSION")
print("=" * 70)
...
# Repurposed_Use = NOT USED because of leakage
...
results.to_csv(
    "evaluation/logistic_regression_results.csv",
    index=False
)
...
cm_df.to_csv(
    "evaluation/logistic_regression_confusion_matrix.csv"
)
...
print(
    coefficient_importance.head(20)
)

coefficient_importance.to_csv(
    "evaluation/logistic_regression_feature_importance.csv",
    index=False
)
...
joblib.dump(
    preprocessor,
    "models/logistic_regression_preprocessor.pkl"
)
...
joblib.dump(
    target_encoder,
    "models/logistic_regression_target_encoder.pkl"
)
...
print("\nReady for four-algorithm comparison.")